...
<div class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
    <a rel="{$input_name|escape:'htmlall':'UTF-8'}" href="#" id="collapse_all-{$input_selector_value|escape:'htmlall':'UTF-8'}" class="btn btn-default" style="padding:3px;">{l s='Collapse All' mod='pm_advancedsearch4'}</a> &nbsp;
    <a rel="{$input_name|escape:'htmlall':'UTF-8'}" href="#" id="expand_all-{$input_selector_value|escape:'htmlall':'UTF-8'}" class="btn btn-default" style="padding:3px;">{l s='Expand All' mod='pm_advancedsearch4'}</a> &nbsp;
    {if empty($use_radio)}
        <a href="#" rel="{$input_name|escape:'htmlall':'UTF-8'}" id="check_all-{$input_selector_value|escape:'htmlall':'UTF-8'}" class="btn btn-default" style="padding:3px;">{l s='Check All' mod='pm_advancedsearch4'}</a> &nbsp;
        <a href="#" rel="{$input_name|escape:'htmlall':'UTF-8'}" id="uncheck_all-{$input_selector_value|escape:'htmlall':'UTF-8'}" class="btn btn-default" style="padding:3px;">{l s='Uncheck All' mod='pm_advancedsearch4'}</a>
    {/if}
</div>
